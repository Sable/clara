...
public interface DANodeFactory extends EAJNodeFactory {
    ...
    public AdviceNameAndParams AdviceNameAndParams(Position pos, String name, List<String> argumentOrder);
    
    public AdviceDependency AdviceDependency(Position pos, List<AdviceNameAndParams> strongAdvice,
    		List<AdviceNameAndParams> weakAdvice);
