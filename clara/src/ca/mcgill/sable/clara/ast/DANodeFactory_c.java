...
import ca.mcgill.sable.clara.ast.AdviceDependency;
import ca.mcgill.sable.clara.ast.AdviceDependency_c;
import ca.mcgill.sable.clara.ast.AdviceName;
import ca.mcgill.sable.clara.ast.AdviceNameAndParams;
import ca.mcgill.sable.clara.ast.AdviceNameAndParams_c;
import ca.mcgill.sable.clara.ast.AdviceName_c;
import ca.mcgill.sable.clara.ast.DAAdviceDecl_c;
import ca.mcgill.sable.clara.ast.DAAspectDecl_c;
import ca.mcgill.sable.clara.ast.DADelFactory;
import ca.mcgill.sable.clara.ast.DADelFactory_c;
import ca.mcgill.sable.clara.ast.DAExtFactory;
import ca.mcgill.sable.clara.ast.DAExtFactory_c;
import ca.mcgill.sable.clara.ast.DANodeFactory;
                              ...
                              implements DANodeFactory
{
	...
	public AdviceDependency AdviceDependency(Position pos,
			List<ca.mcgill.sable.clara.ast.AdviceNameAndParams> strongAdvice,
			List<ca.mcgill.sable.clara.ast.AdviceNameAndParams> weakAdvice) {
