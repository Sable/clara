...
/**
 * An extension node to extend an {@link AdviceDecl} with a human-readable advice name
 * given by the programmer, e.g.: <code>before hn(): call(* *.hasNext()) ...</code> would
 * have the name <code>hn</code>.
 * @author Eric Bodden
 */
public class NameExtension extends Ext_c implements Ext {
	...
	public void setName(AdviceName name) {
		this.name = name;
	}
