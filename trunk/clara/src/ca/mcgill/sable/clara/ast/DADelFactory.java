...
/**
 * Delegate factory for ca.mcgill.sable.clara.
 * 
 * @author Eric Bodden
 */
public interface DADelFactory extends EAJDelFactory {
	...
	/**
     * @return delegates for advice dependency
	 */
	public JL delAdviceDependency();

	/**
     * @return delegates for advice name and param
	 */
	public JL delAdviceNameAndParam();

	/**
     * @return delegates for advice name
	 */
