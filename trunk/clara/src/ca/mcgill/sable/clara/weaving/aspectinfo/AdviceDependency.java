...
import ca.mcgill.sable.clara.weaving.weaver.depadviceopt.ds.ShadowComparator;
import ca.mcgill.sable.clara.weaving.weaver.dynainstr.Probe;
...
import ca.mcgill.sable.clara.weaving.aspectinfo.FixedUniverse;
 ...
 * Such dependencies can either be generated directly from source, via a {@link ca.mcgill.sable.clara.ast.AdviceDependency},
...
public class AdviceDependency {
	 ...
	 * prefixed with {@link ca.mcgill.sable.clara.ast.AdviceDependency#WILDCARD}.
	 */
	...
	public AdviceDependency(Map<String,List<String>> strongAdviceNameToVars, Map<String,List<String>> weakAdviceNameToVars, Aspect container, Position pos) {
		...
		for (String adviceName : strongAdviceNameToVars.keySet()) {
			this.strongAdviceNameToVars.put(adviceName, strongAdviceNameToVars.get(adviceName));
		}
		this.weakAdviceNameToVars = new HashMap<String, List<String>>();
		for (String adviceName : weakAdviceNameToVars.keySet()) {
			this.weakAdviceNameToVars.put(adviceName, weakAdviceNameToVars.get(adviceName));
		}
